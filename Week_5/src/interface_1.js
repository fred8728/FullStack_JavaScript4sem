 ...
 */
function make(title, author, published, pages) {
    return published ? { title: title, author: author, published: published, pages: pages } : { title: title, author: author };
}
var m1 = make('Den grimme ælling', 'H.C Andersen', new Date('1980-12-04'));
console.log(m1);
var bookObject = { title: 'Prinsessen på ærten', author: 'H.C Andersen', published: new Date('1950-05-03'), pages: 89 };
...
var b2 = new Book('Manden og hans hund', 'Frederikke Nilsson', new Date('2020-03-04'), 302);
console.log(b2);
